        ...
        <div class="flex items-center justify-between">
          ...
          <div class="flex items-center gap-1">
            ...
            <button
              ...
              class="w-6 h-6 flex items-center justify-center rounded-md text-text-secondary hover:text-neon-pink hover:bg-neon-pink/10 transition-colors cursor-pointer"
              aria-label="Eliminar"
            >
              <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
            ...
            <a
              ...
              :aria-label="`Ver ${series.title} en IMDB`"
              @click.stop
            >
              <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
